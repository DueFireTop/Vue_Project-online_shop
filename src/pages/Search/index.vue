  ...
  <div>
    ...
    <div class="main">
      <div class="py-container">
        ...
        <!--selector-->
        <!-- @trademarkInfo="trademarkInfoMethod":trademarkInfo是自定义事件名称，trademarkInfoMethod是自定义事件的回调函数名称 -->
        <SearchSelector
          @trademarkInfo="trademarkInfoMethod"
          @attrInfo="attrInfoMethod"
        />
...
export default {
  ...
  methods: {
    ...
    /**
     * @description 自定义事件回调，获取子组件传递过来的品牌信息
     */
